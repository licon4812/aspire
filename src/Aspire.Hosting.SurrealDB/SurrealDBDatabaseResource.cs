...
/// <summary>
/// A resource that represents a MongoDB database. This is a child resource of a <see cref="SurrealDBServerResource"/>.
/// </summary>
public class SurrealDBDatabaseResource : Resource, IResourceWithParent<SurrealDBServerResource>, IResourceWithConnectionString
{
    ...
    public SurrealDBDatabaseResource(string name, string databaseName, SurrealDBServerResource parent) : base(name)
    {
